        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="border border-[#2a2a2a] hover:border-[#F7941D] text-gray-400 hover:text-[#F7941D] font-bold text-xs py-3 px-6 uppercase tracking-widest transition-colors flex items-center justify-center gap-2"
            >
