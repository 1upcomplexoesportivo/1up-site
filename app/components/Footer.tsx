      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm leading-relaxed max-w-xs">
              Complexo esportivo completo em Natal/RN. Eleve seu nível com a
              melhor estrutura da região.
            </p>
            ...
            <div className="flex gap-3 mt-6">
              {socials.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className="w-10 h-10 border border-[#2a2a2a] hover:border-[#F7941D] text-gray-500 hover:text-[#F7941D] flex items-center justify-center transition-colors"
                >
                  {s.icon}
                </a>
              ))}
            ...
            <ul className="space-y-3">
              {links.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-gray-500 hover:text-[#F7941D] text-sm uppercase tracking-wider transition-colors"
                  >
                    {link.label}
                  </a>
                </li>
        ...
        <div className="border-t border-[#1e1e1e] pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-gray-700 text-xs">
            © 2025 1UP Complexo Esportivo. Todos os direitos reservados.
          </p>
          <p className="text-gray-700 text-xs">
            Natal / RN · Brasil
          </p>
